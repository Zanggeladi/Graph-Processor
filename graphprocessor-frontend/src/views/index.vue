<template>
  <div class="homepage">
    ...
    <section class="banner">
      <h1>欢迎来到流模式图数据处理分析平台</h1>
      <p>一个现代化图数据处理与分析平台，提供高效的图计算与实验服务。</p>
    </section>
  ...
  <div class="app-container home">
    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>DBIS图系统后台管理框架</h2>
        <p>
          DBIS 图数据处理分析平台 是一个功能全面、操作简便的平台，采用先进的MVC设计模式和React+SpringBoot等开发框架，提供低灵活性的图数据处理服务和高灵活性的图对比实验服务，支持节点分类、图分类、链接预测等任务，优化了用户的实验流程和分析效率，提升了图数据处理和分析领域的用户体验。
        </p>
        <p>
    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log" shadow="hover">
          ...
          <div class="body">
            <p>
              <i class="el-icon-user-solid"></i> <a href="/system/user" target="_blank">提供用户登录、登出、注册和基本的增删改查功能。用户通过前端表单提交验证信息，后端进行验证并记录登录状态。不同角色的用户在登录后会被引导到各自权限范围内的界面。管理员可以增删用户及修改用户角色权限。</a>
            </p>
          </div>
        </el-card>
      </el-col>
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log" shadow="hover">
          ...
          <div class="body">
            <p>
              <i class="el-icon-user-solid"></i> <a href="/admin/model" target="_blank">包括图数据集管理和模型管理。用户可以上传和管理不同类型的图数据集，并能选择和管理不同的图模型，支持对图数据进行各种处理和分析。</a>
            </p>
          </div>
        </el-card>
      </el-col>
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log" shadow="hover">
          ...
          <div class="body">
            <p>
              <i class="el-icon-user-solid"></i> <a href="/official/officialmodeltask" target="_blank">包含图数据处理任务和图对比实验任务管理。用户可以创建、管理和监控图数据处理任务，平台支持异步处理和任务结果保存。此外，用户还可以创建图对比实验任务，进行不同图数据集和模型之间的对比实验。</a>
            </p>
          </div>
        </el-card>
      </el-col>
    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log" shadow="hover">
          ...
          <div class="body">
            <p>
              <i class="el-icon-s-promotion"></i> DBIS官网：<el-link
                href="https://dbis.nankai.edu.cn/"
                target="_blank"
                >https://dbis.nankai.edu.cn/</el-link
              >
            </p>
            <p>
...
const features = ref([
      {
        title: "用户管理模块",
        description: "提供用户登录、登出、注册和基本的增删改查功能。用户通过前端表单提交验证信息，后端进行验证并记录登录状态。不同角色的用户在登录后会被引导到各自权限范围内的界面。管理员可以增删用户及修改用户角色权限。",
  // <a href="/system/user" target="_blank">提供用户登录、登出、注册和基本的增删改查功能。用户通过前端表单提交验证信息，后端进行验证并记录登录状态。不同角色的用户在登录后会被引导到各自权限范围内的界面。管理员可以增删用户及修改用户角色权限。</a>
        buttonText: "查看详情",
        link: "https://example.com/feature1",
      },
      {
        title: "资源管理模块",
        description: "包括图数据集管理和模型管理。用户可以上传和管理不同类型的图数据集，并能选择和管理不同的图模型，支持对图数据进行各种处理和分析。",
        // <a href="/admin/model" target="_blank">包括图数据集管理和模型管理。用户可以上传和管理不同类型的图数据集，并能选择和管理不同的图模型，支持对图数据进行各种处理和分析。</a>
        buttonText: "查看详情",
        link: "/admin/model",
      },
  {
    title: "任务管理模块",
    description: "包含图数据处理任务和图对比实验任务管理。用户可以创建、管理和监控图数据处理任务，平台支持异步处理和任务结果保存。此外，用户还可以创建图对比实验任务，进行不同图数据集和模型之间的对比实验。",
    // <a href="/official/officialmodeltask" target="_blank">包含图数据处理任务和图对比实验任务管理。用户可以创建、管理和监控图数据处理任务，平台支持异步处理和任务结果保存。此外，用户还可以创建图对比实验任务，进行不同图数据集和模型之间的对比实验。</a>
    buttonText: "查看详情",
    link: "/official/officialmodeltask",
  },
])
