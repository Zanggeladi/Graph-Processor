<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="数据集类型" prop="datasetType" label-width="85px">
      ...
      <el-form-item label="数据集名称" prop="datasetName" label-width="85px">
        <el-input
...
<!--      <el-table-column label="image路径" align="center" prop="imgPath" />-->
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="chakan" @click="handleDelete(scope.row)" v-hasRole="['common']">查看任务结果</el-button>
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasRole="['common']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasRole="['common']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="officialmodeltaskRef" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="模型id" prop="officialModelId">
...
import { listMyOfficialmodeltask, getOfficialmodeltask, delOfficialmodeltask, addOfficialmodeltask, updateOfficialmodeltask } from "@/api/graphprocesser/officialmodeltask";
...
function getList() {
  loading.value = true;
  listMyOfficialmodeltask(queryParams.value).then(response => {
